...
const dummyAvailabilities = [
  {
    ...
    sector: 'Automobile',
    quantity: 500,
    pricePerShare: 950.50,
    minQuantity: 100,
    validity: '2024-08-30T17:00:00Z',
    description: 'High-quality Tata Motors shares available for immediate sale. Willing to negotiate on bulk orders.',
    deliveryMethod: 'demat',
    status: 'pending',
    postedAt: '2024-08-11T10:00:00Z',
    viewCount: 15,
    inquiries: 3,
    offers: [
