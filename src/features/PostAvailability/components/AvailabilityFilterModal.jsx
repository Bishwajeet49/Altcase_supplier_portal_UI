...
const AvailabilityFilterModal = ({ isOpen, onClose, filters, onFilterChange, searchTerm, onSearchChange }) => {
  const statusOptions = [
  ...
  const sortOptions = [
    ...
    { value: 'most_inquiries', label: 'Most Inquiries' }
  ];
      ...
      <div className="bg-theme-bgPrimary border border-theme-borderPrimary rounded-2xl shadow-2xl w-full max-w-md max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-theme-borderSecondary">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-bold text-theme-textPrimary">Filter Availabilities</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          {/* Status Filter */}
          <div>
            <label className="block text-sm font-medium text-theme-textPrimary mb-2">Status</label>
            <select
...
export default AvailabilityFilterModal;
